...
system(paste("plink --bfile /group/ober-resources/users/smozaffari/ASE/data/plinkfiles/Hutterite_paternal431 --chr ",
              chr ," --from-bp ",
              bp, " --to-bp ", bp,
              " --recode --out ", chr, "_snppat", bp, sep=""))

system(paste("plink --bfile /group/ober-resources/users/smozaffari/ASE/data/plinkfiles/Hutterite_maternal431 --chr ",
              chr ," --from-bp ",
             bp, " --to-bp ", bp,
