...
write.table(table, "Asymmetry_10000_08.30p_all.txt", quote = F, row.names = T, col.names = F)
...
while (length(asym2$pvals) > 10) {
  ...
  write.table(table, paste("Asymmetry_10000_08.30p_",t,".txt",sep="") , quote = F, row.names = T, col.names = F)
}
