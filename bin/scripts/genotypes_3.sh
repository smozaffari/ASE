#!/bin/bash
# Author: SVM 
# Purpose: make genotype files for WASP
# USAGE: bash genotypes_3.sh 
...
echo "qsub -v SCRIPTDIR=$scriptDir -N WASP_gtypes $scriptDir/genotypes_2.pbs" | tee -a $setup_log
qsub -v SCRIPTDIR=$scriptDir -N WASP_gtypes $scriptDir/genotypes_2.pbs 2>&1
