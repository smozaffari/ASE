...
```{r imprintedgenes, echo=FALSE, eval=TRUE}
...
```{r weighted, echo=FALSE, eval=FALSE}
CS <- read.table("~/Documents/POexpressionpaper/Analyses/Data/CS_04.23.txt", check.names=F, header=F)
CS2 <- CS$V2
names(CS2) <- CS$V1
...
```{r moreeval, echo=FALSE, eval=FALSE}
...
```{r singleplotsweighted, results="asis", echo=FALSE, echo=FALSE}
...
```{r plotsold, eval=FALSE, echo=FALSE}
