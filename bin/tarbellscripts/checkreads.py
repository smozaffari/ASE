...
#                                if snp.alleles[0]!= snp.alleles[1]:
                                if seq[p] == snp.alleles[0]:
                                    ...
                                    matches+=1
                                    seqs.append(seq)
#                                    print self.chr_name, self.pos+p+1, seq[p], snp.alleles[0], p, indx, start_dist, seq
                                else:
#                                    seqs.append(seq)
                                    print self.chr_name, self.pos+p+1, "doesn't match", seq[p], snp.alleles[0], snp.alleles[1], p, indx, seq
